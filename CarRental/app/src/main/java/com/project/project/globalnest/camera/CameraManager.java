...
import com.project.project.scanner.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    private static final int MAX_FRAME_WIDTH = 320; //480; //600;
    private static final int MAX_FRAME_HEIGHT = 360;// 400;
